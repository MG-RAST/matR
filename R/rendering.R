...
setMethod ("render", "heatmap", 
           function (x, ...) {
             parDefaults = list (
               ...
               toFile =  "HD.png", image_title = toFile,
               ...
               breaks, symbreaks = min(x < 0, na.rm = TRUE) || scale != "none",
               ...
               xlab = NULL, ylab = NULL,
               # plot layout
               lmat = NULL, lhei = NULL, lwid = NULL)                        # <--- line height multiplier
...
{ 
             ...
             if(identical(figure_type, "pdf")){
               ...
               CairoPDF(file = toFile, width = figure_width, height = figure_height, res = fiure_res, units = "px")
             }
             ...
             if (identical(figure_type, "ps")){
               ...
               CairoPS(file = toFile, width = figure_width, height = figure_height, res = fiure_res, units = "px")
             }
